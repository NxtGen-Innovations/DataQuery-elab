...
import { BookOpen, Brain, BarChart2, ChevronRight, Circle } from 'lucide-react'
                  ...
                  <div key={topicGroup.topic}>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
                      {topicGroup.lessons.map((lesson) => (
                        <Card
                          key={lesson.id}
                          className="bg-[#111111] border-white/5 hover:border-purple-500/25 transition-all duration-200 group relative overflow-hidden"
                        >
                          {/* Hover glow */}
                          ...
                          <CardContent className="p-4 flex items-center gap-4">
                            ...
                            <div className="flex items-center gap-2 shrink-0">
                              <Link href={`/curriculum/${lesson.id}`}>
                                <Button variant="secondary" size="sm" className="h-8 px-3 text-[11px] font-bold bg-white/5 border-white/5 hover:bg-white/10 text-white">
                                  Sheet
                                </Button>
                              </Link>
                              <Button size="sm" className="h-8 px-3 text-[11px] font-bold bg-transparent text-orange-400 border border-orange-500/20 hover:bg-orange-500/10">
                                Track
                              </Button>
                            </div>
                          </CardContent>
